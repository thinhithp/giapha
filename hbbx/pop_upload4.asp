...
If (CStr(Request.QueryString("AF_upload")) <> "") Then
  AF_redirectPage = "pop_upload4.asp?er=1"
  ...
  for AF_i = 0 to UploadRequest.Count - 1
    ...
    if UploadRequest.Item(AF_curKey).Item("FileName") <> "" then
      ...
      AF_curPath ="../Images/Gallery/" ' Request.ServerVariables("PATH_INFO") 
...
//Ham nay tra ve ten cua file cho trang truoc
	...
	//	alert(ten_file);
		window.opener.document.frmAddNews.pathanh.value="../Images/Gallery/"+ten_file;
		window.close()
	}
//-->
</script>
