...
<div style="width:100%; background-image:url(../images/bgtren.png); background-size: 100%; background-origin: content; background-repeat: no-repeat; margin:0 0 0 0;"><table width="830" border="0" cellspacing="0" cellpadding="0" align="center">
  ...
  <table width="830" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		<td align="left"><font class="giapha"><b>TỪ ĐƯỜNG, HƯƠNG HỎA DÒNG HỌ</b></font></td>
  ...
  <table width="830" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td valign="top" width="552"><%=rs("tuduong")%></td>
    <td width="20"></td>
