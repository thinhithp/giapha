...
* by Dao Van Trong [support@trong.cz.cc]
* Copyright ©  ™† (¯`·_°»• Đào Văn Trong •«°_·´¯) †™". All Rights Reserved.
*/                                             
...
// e.g. SCRIPT_PATH= "../../www.mysite.net/js/";
//
...
var ermsg1="Sorry, trình duyệt của bạn không cho phép nạp thêm Module";
var ermsg2="Module chưa nạp xong, có thể kết nối chậm...\n"+
"Bạn hãy thực hiện thao tác một lần nữa!";
...
function convertAtOnce(txtarea) {
  ...
  if(theTyper.keymode.off) {
    var msg =  "Bộ gõ đang ở trạng thái tắt.\n Bạn phải đưa về "+
    "kiểu đã dùng để viết bài truớc khi soát dấu";
    return alert(msg);      
  }
